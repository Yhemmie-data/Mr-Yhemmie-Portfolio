...
### Conclusion
  The study's thorough analysis of data collected from Amiable Autos Limited has provided valuable insights into the dynamics driving Nigeria's burgeoning used car industry. The acknowledgment of the industry's surge, marked by a notable 20% annual growth rate over the past three years, underscores the economic considerations and consumer preferences shaping this trend. By delving into demographic information, including gender, age, geography, and purchasing behavior among Amiable Ltd.’s 1000-strong customer base, the study has shed light on key factors influencing the targeted customer profile. Notably, sectors such as Financial Services and Manufacturing have emerged as focal points for used car purchases, reflecting higher purchasing power and market engagement within these segments.
